...
public class Objective4Lab2 {
  public static void main(String[] args) {
    ...
    System.out.println("Please eneter the first decimal number you would like to add.");
    ...
    int integerSum = num1 + num2 + num3;
    double doubleSum = dub1 + dub2 + dub3;
    System.out.println("The sum of " + num1 + " + " + num2 + " + " + num3 + " = " + integerSum);
