...
public class BooleanExpressions {
  ...
  public static void main(String[] args) {
      ...
      System.out.println(num1 + " is grater than " + num2 +" : " + bool2);
      System.out.println(num1 + " is less than or equal to " + " : " + bool3);
      System.out.println(num1 + " is greater than or equal to " + " : " + bool4);
